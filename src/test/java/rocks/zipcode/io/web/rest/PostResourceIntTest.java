...
public class PostResourceIntTest {
    ...
    private static final Long DEFAULT_NUMBER_OF_COMMENTS = 1L;
    private static final Long UPDATED_NUMBER_OF_COMMENTS = 2L;
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getNumberOfComments()).isEqualTo(DEFAULT_NUMBER_OF_COMMENTS);
        assertThat(testPost.getContent()).isEqualTo(DEFAULT_CONTENT);
        assertThat(testPost.getLikes()).isEqualTo(DEFAULT_LIKES);
        assertThat(testPost.getDislikes()).isEqualTo(DEFAULT_DISLIKES);
    }
    ...
    public void getAllPosts() throws Exception {
        ...
        restPostMockMvc.perform(get("/api/posts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberOfComments").value(hasItem(DEFAULT_NUMBER_OF_COMMENTS.intValue())))
    ...
    public void getPost() throws Exception {
        ...
        restPostMockMvc.perform(get("/api/posts/{id}", post.getId()))
            ...
            .andExpect(jsonPath("$.numberOfComments").value(DEFAULT_NUMBER_OF_COMMENTS.intValue()))
    ...
    public void updatePost() throws Exception {
        ...
        Post testPost = postList.get(postList.size() - 1);
        assertThat(testPost.getNumberOfComments()).isEqualTo(UPDATED_NUMBER_OF_COMMENTS);
        assertThat(testPost.getContent()).isEqualTo(UPDATED_CONTENT);
        assertThat(testPost.getLikes()).isEqualTo(UPDATED_LIKES);
        assertThat(testPost.getDislikes()).isEqualTo(UPDATED_DISLIKES);
    }
