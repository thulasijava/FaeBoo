...
var comment_delete_dialog_component_1 = require("app/entities/comment/comment-delete-dialog.component");
var comment_service_1 = require("app/entities/comment/comment.service");
describe('Component Tests', function () {
    describe('Comment Management Delete Component', function () {
        var comp;
        var fixture;
        var service;
        ...
        beforeEach(function () {
            testing_1.TestBed.configureTestingModule({
                ...
                declarations: [comment_delete_dialog_component_1.CommentDeleteDialogComponent]
            })
                .overrideTemplate(comment_delete_dialog_component_1.CommentDeleteDialogComponent, '')
                .compileComponents();
            fixture = testing_1.TestBed.createComponent(comment_delete_dialog_component_1.CommentDeleteDialogComponent);
...
//# sourceMappingURL=comment-delete-dialog.component.spec.js.map